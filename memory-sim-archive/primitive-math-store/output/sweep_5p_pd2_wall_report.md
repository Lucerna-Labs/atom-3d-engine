...
- Timestamp: `2026-06-24T01:41:59.991438+00:00`
- Seed: `42`
...
### Recipe #7 🌐 — score 655.0

- **Primitives**: bayesian-posterior-inference, chain-of-thought, computation-tree-logic, integer-programming, maximum-likelihood-estimation
...
### Recipe #9 🌐 — score 655.0

- **Primitives**: bayesian-posterior-inference, chain-of-thought, computation-tree-logic, linear-relaxation, maximum-likelihood-estimation
- **Domains**: agentic-reasoning, combinatorial-optimization, formal-verification, statistics-probability
- **Categories**: agentic-reasoning, combinatorial-optimization, formal-verification, statistics-probability
- **Wiring**: fusion ranking
- **Architecture**: 0 composite + 5 atomic
...
### Recipe #11 🌐 — score 655.0

- **Primitives**: bayesian-posterior-inference, chain-of-thought, computation-tree-logic, maximum-likelihood-estimation, state-transition-system
...
### Recipe #12 🌐 — score 655.0

- **Primitives**: bayesian-posterior-inference, chain-of-thought, computation-tree-logic, maximum-likelihood-estimation, structural-causal-model
...
### Recipe #13 🌐 — score 655.0

- **Primitives**: bayesian-posterior-inference, chain-of-thought, computation-tree-logic, maximum-likelihood-estimation, tree-of-thought
- **Domains**: agentic-reasoning, formal-verification, statistics-probability
- **Categories**: agentic-reasoning, formal-verification, statistics-probability
- **Wiring**: fusion ranking
- **Architecture**: 0 composite + 5 atomic
