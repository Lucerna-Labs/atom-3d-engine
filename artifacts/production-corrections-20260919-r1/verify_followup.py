...
OUT = ROOT / "artifacts/production-corrections-20260919-r2"
...
for name, command in [
    ...
    ("tests", ["cargo", "test", "--offline", "-p", "mm3e-kit", "-p", "mm3e-orchestrator", "-p", "mm3e-editor", "--tests", "--no-fail-fast"]),
